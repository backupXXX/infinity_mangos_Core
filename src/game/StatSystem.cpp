...
bool Player::UpdateStats(Stats stat)
{
    ...
    if(Pet* pet = GetPet())
        pet->ApplyStatScalingBonus(stat, false);
...
void Player::ApplySpellPowerBonus(int32 amount, bool apply)
{
    ...
    if(Pet* pet = GetPet())
    {
        pet->ApplyAttackPowerScalingBonus(false);
        pet->ApplyDamageScalingBonus(false);
    }
}
...
void Player::UpdateResistances(uint32 school)
{
    ...
    if(Pet* pet = GetPet())
        pet->ApplyResistanceScalingBonus(SpellSchools(school),false);
...
void Player::UpdateArmor()
{
    ...
    if(Pet* pet = GetPet())
       pet->ApplyResistanceScalingBonus(SPELL_SCHOOL_NORMAL,false);
...
void Player::UpdateMeleeHitChances()
{
    ...
    if(Pet* pet = GetPet())
       pet->ApplyHitScalingBonus(false);
}
...
void Player::UpdateSpellHitChances()
{
    ...
    if(Pet* pet = GetPet())
        pet->ApplySpellHitScalingBonus(false);
}
...
void Player::UpdateExpertise(WeaponAttackType attack)
{
    ...
    if(Pet* pet = GetPet())
        pet->ApplyExpertizeScalingBonus(false);
...
void Player::UpdateManaRegen()
{
    ...
    if(Pet* pet = GetPet())
        pet->ApplyPowerregenScalingBonus(false);
